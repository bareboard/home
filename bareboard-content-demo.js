...
(() => {
  ...
  const DEMO_HEADLINES = [
    'DRC Concentrate Ban Changes Cobalt Delivery Risk',
  ...
  const DEMO_SUMMARIES = [
    'The decisive signal is deliverable material: mine output, processing capacity, licensing and logistics must all align before supply reaches customers.',
  ...
  document.title = 'UMS LIVE | Critical Minerals Intelligence';
